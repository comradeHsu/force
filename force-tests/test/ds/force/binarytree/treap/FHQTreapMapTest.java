...
public class FHQTreapMapTest extends TestCase {

    public static FHQTreapMap<Integer,Integer> init(){
        FHQTreapMap<Integer,Integer> map = new FHQTreapMap<>();
    ...
    public void testPut(){
        FHQTreapMap<Integer,Integer> treapMap = new FHQTreapMap<>();
        for (int i = 1; i < 10; i++) {
            treapMap.put(i,i);
        }
        treapMap.get(1);
    ...
    public void testGet() {
        Map<Integer, Integer> map = new FHQTreapMap<>();
        map.put(3, 3);
    ...
    public void testFloorEntry(){
        NavigableMap<Integer,Integer> map = new FHQTreapMap<>();
    ...
    public void testDescendingMap(){
        FHQTreapMap<Integer,Integer> map = init();
    ...
    public void testSplit(){
        ...
        FHQTreapMap<Integer,Integer> zero = map.split(3);
