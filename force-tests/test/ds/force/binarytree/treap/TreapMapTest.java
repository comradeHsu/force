...
public class TreapMapTest extends TestCase {
    ...
    public void testPut(){
        TreapMap<Integer,Integer> splayTreeMap = new TreapMap<>();
        for (int i = 1; i < 10; i++) {
    ...
    public void testFloorEntry(){
        NavigableMap<Integer,Integer> map = new TreapMap<>();
    ...
    public void testLowerEntry(){
        NavigableMap<Integer,Integer> map = MapUtil.init(TreapMap.class);
    ...
    public void testDescendingMap(){
        TreapMap<Integer,Integer> map = MapUtil.init(TreapMap.class);
    ...
    public void testSplit(){
        ...
        TreapMap<Integer,Integer> zero = map.split(3);
